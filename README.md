...
| [Gym Coach](projects/gym_coach) | Generates a Claude-powered workout programme from stats, training days, and a goal | Claude integration, prompt + schema length contracts, themed UI |
...
- **LLM APIs** — OpenAI (`gpt-4.1-mini`) and Anthropic Claude (`claude-sonnet-4-6` for Date Night Planner, `claude-sonnet-4-5` for Gym Coach)
...
#    (OPENAI_API_KEY for most projects, ANTHROPIC_API_KEY for date_night and gym_coach)
